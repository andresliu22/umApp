...
class OrionFilterVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        OrionFilterManager.shared.orionFiltersVC = self
    ...
    @IBAction func applyFilters(_ sender: UIButton) {
        self.dismiss(animated: true) {
            OrionManager.shared.orionVC.arrayYear = self.arrayYear
            OrionManager.shared.orionVC.getBarChart()
        }
    }
...
extension OrionFilterVC: UITableViewDataSource {
...
extension OrionFilterVC: UITableViewDelegate {
    
}

extension OrionFilterVC: UISearchBarDelegate {
