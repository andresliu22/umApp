...
class DetailFilterVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        DetailFilterManager.shared.detailFiltersVC = self
    ...
    @IBAction func applyFilters(_ sender: UIButton) {
        self.dismiss(animated: true) {
            DetailManager.shared.detailVC.arrayYear = self.arrayYear
            DetailManager.shared.detailVC.getLineChart()
        }
    }
...
extension DetailFilterVC: UITableViewDataSource {
...
extension DetailFilterVC: UITableViewDelegate {
    
}

extension DetailFilterVC: UISearchBarDelegate {
