...
open class PieChartView: PieRadarChartViewBase
{
    ...
    private var _holeBorderWidth: CGFloat = 1.0
    
    private var _holeBorderColor: NSUIColor? = NSUIColor.white
    ...
    @objc open var holeBorderColor: NSUIColor?
    {
        get
        {
            return _holeBorderColor
        }
        set
        {
            _holeBorderColor = newValue
            setNeedsDisplay()
        }
    }
    /// if true, the hole will see-through to the inner tips of the slices
